...
templateservicemod.service('TemplateService', function() {
    ...
    this.meta = "Wohlig,Wohlig Technology,Creative Agency,Development Firm,NodeJS,MongoDB,Web Development,Android,iOS,iPhone,iPad,iWatch,Selig,Web Designing";
    this.metadesc = "Software development firm who have carved a niche in founding in the field of Web & App development. Projects that we've developed mainly show our creativity and excellence, we've made ourselves adaptable to the latest technology and we've developed a name in integrating various services on one platform with simplicity.";
